          ...
          <CardContent>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart
                  data={[
                    { day: 'Mon', revenue: 12100000 },
                    { day: 'Tue', revenue: 14500000 },
                    { day: 'Wed', revenue: 13200000 },
                    { day: 'Thu', revenue: 19500000 },
                    { day: 'Fri', revenue: 16800000 },
                    { day: 'Sat', revenue: 14200000 },
                    { day: 'Sun', revenue: 12100000 },
                  ]}
            ...
            <div className="flex items-center justify-between mt-4 text-sm text-muted-foreground">
              <span>Average: {formatCurrency(16071428)}/day</span>
              <span>Peak: {formatCurrency(19500000)} (Thu)</span>
              <span>Low: {formatCurrency(12100000)} (Sun)</span>
            </div>
          </CardContent>
        </Card>
